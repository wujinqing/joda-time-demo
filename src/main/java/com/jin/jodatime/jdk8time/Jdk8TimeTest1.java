 ...
 * @date 2017年04月25日
 */
public class Jdk8TimeTest1 {
    public static void main(String[] args) {
//        LocalDate localDate1 = LocalDate.now();
//        LocalDate localDate2 = localDate1.plusDays(20).plusMonths(2);
//
...
//        ZoneId.getAvailableZoneIds().forEach(System.out::println);
        ...
        System.out.println(JSON.toJSONString(localDate, SerializerFeature.PrettyFormat));
